        ...
        <footer className="footer">
            <div className="footer-columns">
                ...
                <div className="footer-column">
                    <h4>Shop</h4>
                    <ul>
                        <li><a href="#juices">Got Da Juices</a></li>
                        <li><a href="#reboot">Reboot</a></li>
                        <li><a href="#superfood">Got Da Superfood</a></li>
                        <li><a href="#superfood">Got Da Immune Booster</a></li>
                        <li><a href="#box">Build-a-Box</a></li>
                    </ul>
                </div>
                <div className="footer-column">
                    <h4>Quick Links</h4>
                    <ul>
                        ...
                        <li><a href="#faq">Manage Subscription</a></li>
                    </ul>
                </div>
                <div className="footer-column">
                    <h4>Our Store</h4>
                    <p>309 Pacific Ave, Jersey City, NJ</p>
                    <a href="tel:+12012738227" className="phone-number">(201) 273-8227</a>
                    <p><a href="mailto:info@gotdajuicebar.com">info@gotdajuicebar.com</a></p>
                </div>
            </div>
