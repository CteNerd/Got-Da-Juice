...
function Home() {
    const products = [
        { primaryImage: JuiceDeliveryBox, secondaryImage: FujiGoddessProfile, name: 'Signature Reboot Cleanse', price: 55, categories: ['Best Sellers', 'Reboot'] },
        { primaryImage: GreenMagic, secondaryImage: GreenMagicNutrition, name: 'Green Magic', price: 10, categories: ['Best Sellers', 'Got Da Juice']  },
        { primaryImage: BlackMamba, secondaryImage: BlackMagicProfile, name: 'Black Mamba', price: 10, categories: ['Best Sellers', 'Got Da Juice']  },
        { primaryImage: FujiGoddess, secondaryImage: FujiGoddessNutrition, name: 'Fuji Goddess', price: 10, categories: ['Best Sellers', 'Got Da Juice']  },
        { primaryImage: CrazyGreens, secondaryImage: FujiGoddessNutrition, name: 'Crazy Greens', price: 11, categories: ['Got Da Juice']  },
        { primaryImage: OldKayneProfile, secondaryImage: OldKayne, name: 'Old Kayne', price: 5, categories: ['Immune System Boost']  },
        { primaryImage: OldKayneWellnessKit, secondaryImage: OldKaynex2, name: 'Old Kayne Welness Kit', price: 33, categories: ['Immune System Boost', 'Reboot']  },
        { primaryImage: BlueDream, secondaryImage: BlueDream, name: 'Blue Dream', price: 4.50, categories: ['Immune System Boost', 'Reboot']  },
        { primaryImage: GreenJuiceReboot, secondaryImage: CrazyGreens, name: 'Green Juice Reboot', price: 55, categories: ['Reboot']  },
    ];
